...
LOGO.Image = "rbxassetid://16653557427"
...
loki.Image = "rbxassetid://16653557427"
...
do  local ui =  game:GetService("CoreGui").RobloxGui.Modules:FindFirstChild("Phoenix Hub")  if ui then ui:Destroy() end end
...
local Phoenix Hub = Instance.new("ScreenGui")
Phoenix Hub.Name = "Phoenix Hub"
Phoenix Hub.Parent = game.CoreGui
Phoenix Hub.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

local Main = Instance.new("Frame")
Main.Name = "Main"
Main.Parent = Phoenix Hub
